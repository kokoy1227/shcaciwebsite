...
$edit = $_GET['edit'];
 ...
 $resultt = mysqli_query($con,"SELECT * FROM activities where id=".$edit."");
...
$folder = "images/activities/".$lis_img;
if($edit==''){

move_uploaded_file($tempname, $folder);

$insertdata = mysqli_query($con,"INSERT INTO activities(title,short,descrip,img,date,status)VALUES('$title','$short','$descrip','$lis_img','$today','0')");
echo "<script>alert('Posted Successfully');</script>
	<script>window.location.href = 'add-activities.php'</script>";
}
else{
move_uploaded_file($tempname, $folder);

$insertdata = mysqli_query($con,"UPDATE activities SET title='$title',short='$short',descrip='$descrip',img='$lis_img',date='$today' where id=".$edit."");
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
          <a href="view-activities.php" class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i>  View School Events</a>
          </div>
